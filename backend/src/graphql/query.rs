...
impl RootQuery {
    ...
    pub async fn user_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by user ID")] id: String,
    ) -> FieldResult<User> {
    ...
    pub async fn users_by_ids(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by user ID")] ids: Vec<String>,
    ...
    pub async fn user_by_email(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by user ID")] email: String,
    ) -> FieldResult<User> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("users");
    ...
    pub async fn asset_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by asset ID")] id: String,
    ) -> FieldResult<Asset> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("assets");
        let converted_id = match bson::oid::ObjectId::with_string(&id) {
    ...
    pub async fn assets_by_owner_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by user ID")] owner_id: String,
    ...
    pub async fn org_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by org ID")] id: String,
    ) -> FieldResult<Org> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("orgs");
        let converted_id = match bson::oid::ObjectId::with_string(&id) {
    ...
    pub async fn product_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by product ID")] id: String,
    ) -> FieldResult<Product> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("products");
        let converted_id = match bson::oid::ObjectId::with_string(&id) {
    ...
    pub async fn profile_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by profile ID")] id: String,
    ) -> FieldResult<Profile> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("profiles");
        let converted_id = match bson::oid::ObjectId::with_string(&id) {
    ...
    pub async fn role_by_id(
        &self,
        ctx: &Context<'_>,
        #[graphql(desc = "Query by role ID")] id: String,
    ) -> FieldResult<Role> {
        let db = ctx.data_unchecked::<AppContext>().db_pool.clone();
        let collection = db.database("AppStore").collection("roles");
        let converted_id = match bson::oid::ObjectId::with_string(&id) {
